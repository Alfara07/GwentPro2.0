    ...
    public void Invocar()
    {
        ...
        if (Deck.Card_Invoke != null && !Deck.Card_Invoke.GetComponent<GeneralCard>().invoke && !gameManager.invoke && gameManager.Turn == Deck.Player)
        {
            ...
            foreach(AttackClass att in Deck.Card_Invoke.GetComponent<GeneralCard>().Attack)
            {
                if (att == attackType)
                {                   
                    if (Deck.Card_Invoke.GetComponent<GeneralCard>().Type == CardClass.Oro || Deck.Card_Invoke.GetComponent<GeneralCard>().Type == CardClass.Plata && Deck.Field[casilla] == null)
                    {
