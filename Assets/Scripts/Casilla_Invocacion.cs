...
public class Casilla_Invocacion : MonoBehaviour
{
    ...
    public void Invocar()
    {
        ...
        if (Deck.Card_Invoke != null && !Deck.Card_Invoke.GetComponent<GeneralCard>().invoke && !gameManager.invoke && gameManager.Turn == Deck.Player)
        {
            ...
            foreach(AttackClass att in Deck.Card_Invoke.GetComponent<GeneralCard>().Attack)
            {
                if (att == attackType)
                {                   
                    if ((Deck.Card_Invoke.GetComponent<GeneralCard>().Type == CardClass.Oro || Deck.Card_Invoke.GetComponent<GeneralCard>().Type == CardClass.Plata) && casilla <= 11 && Deck.Field[casilla] == null)
                    {
                    ...
                    if (Deck.Card_Invoke.GetComponent<GeneralCard>().Type == CardClass.Clima)
                    {
                        if(att == AttackClass.Melee && gameManager.Climas[0] == null && casilla == 12)
                        {
                        ...
                        if (att == AttackClass.Ranged && gameManager.Climas[1] == null && casilla == 13)
                        {
                        ...
                        if (att == AttackClass.Siege && gameManager.Climas[2] == null  && casilla == 14)
                        {
                    ...
                    if (Deck.Card_Invoke.GetComponent<GeneralCard>().Type == CardClass.Aumento)
                    {
                        if (att == AttackClass.Melee && Deck.Aum[0] == null && casilla == 15)
                        {
                        ...
                        if (att == AttackClass.Ranged && Deck.Aum[1] == null && casilla == 16)
                        {
                        ...
                        if (att == AttackClass.Siege && Deck.Aum[2] == null && casilla == 17)
                        {
